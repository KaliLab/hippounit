...
class ProvidesRecordingLocationsOnTrunk(sciunit.Capability):
	...
	def find_trunk_locations_multiproc(self, distances):
		...
		self.dend_locations, actual_distances = pool_trunk.apply(self.find_trunk_locations, (distances,))  # this way model.dend_loc gets the values
